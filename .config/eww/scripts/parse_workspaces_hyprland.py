...
icon_map_path = "/home/paolo/.config/eww/scripts/workspaces_map.json"
...
def main():
    ...
    with socket.socket(socket.AF_UNIX, socket.SOCK_STREAM) as socket_client:
        ...
        while True:
            ...
            if 'class' in activewindow_json:
                current_window_title = activewindow_json['class']
            ...
            # Block on next call
            line = socket_client.recv(4096).decode()
